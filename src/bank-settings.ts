...
export class BankSettings {
  ...
  static getDefaultCurrency(): string {
    return game.settings.get('foundrybank', 'defaultCurrency') as string;
  }
  ...
  static isLoggingEnabled(): boolean {
    return game.settings.get('foundrybank', 'enableLogging') as boolean;
  }
  ...
  static getTransactionHistoryLimit(): number {
    return game.settings.get('foundrybank', 'transactionHistoryLimit') as number;
  }
  ...
  static isShiftClickEnabled(): boolean {
    return game.settings.get('foundrybank', 'enableShiftClick') as boolean;
  }
}
